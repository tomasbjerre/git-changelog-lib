...
public class GitRepoTest {
  ...
  @Test
  public void testThatRepoFilterincreasesTheNumberOfCommitsUsingMultiplePathFilters() throws Exception {
    final GitRepo gitRepo = this.getGitRepo();
  ...
  @Test
  public void testThatRepoFilterincreasesTheNumberOfCommitsUsingBothPathFilterAndMultiplePathFilters() throws Exception {
    final GitRepo gitRepo = this.getGitRepo();

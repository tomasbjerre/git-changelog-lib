...
public class TemplatesTest {
  ...
  public void before() throws Exception {
    ...
    mockedRestClient //
        ...
        .addMockedResponse(
            "/jira/rest/api/2/issue/JIR-1234?fields=parent,summary,issuetype,labels",
            Resources.toString(getResource("jira-issue-jir-1234.json"), UTF_8)) //
        .addMockedResponse(
            "/jira/rest/api/2/issue/JIR-5262?fields=parent,summary,issuetype,labels",
    ...
    GitHubServiceFactory.getGitHubService(

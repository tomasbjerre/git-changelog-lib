...
public class CommitTest {
 ...
 private final String messageOnlyOneLineAfterTitle = " message title\n * The first item\n *  The second item";
 private final String messageOnlyOneLineAfterTitleAndOneEmptyLine = " message title\n *  The first item\n\n * The second item";
 private final String messageOnlyOneLineAfterTitleAndNoStars = " message title\nThe first item\n The second item";

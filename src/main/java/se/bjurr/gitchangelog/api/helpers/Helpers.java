...
private static Object each(final Options options, final List<String> elements) throws IOException {
	return new EachHelper().apply(elements, options);
}


private static Buffer conditional(final Options options, final boolean condition) throws IOException {
...
private static boolean containsType(final List<Commit> commits,
